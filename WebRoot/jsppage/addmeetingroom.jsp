...
<script type="text/javascript">
        ...
        window.onload = function() {
    		document.form.onsubmit = function() {
    			return roomcode_flag && roomname_flag && capacity_flag  && status_flag;
    		}
    	}
        </script>
				...
				<table class="formtable">
					<tr>
						...
						<td><input id="roomnumber" name="roomcode" type="text"
							placeholder="例如：201" maxlength="10" onblur="validRoomcode()" /> <label
							id="rc_msg" class="e_msg"></label></td>
					</tr>
					<tr>
						<td>会议室名称:</td>
						<td><input id="roomname" name="roomname" type="text"
							placeholder="例如：第一会议室" maxlength="20" onblur="validRoomname()" />
							<label id="rn_msg" class="e_msg"></label></td>
					</tr>
					<tr>
						<td>最多容纳人数：</td>
						<td><input id="roomcapacity" name="capacity" type="text"
							placeholder="填写一个正整数" onblur="validCapacity()" /> <label
							id="cc_msg" class="e_msg"></label></td>
					</tr>
					<tr>
						<td>当前状态：</td>
